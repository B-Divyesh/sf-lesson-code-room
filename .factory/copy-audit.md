...
| --- | --- |
| Shared teaching space | room |
| Person leading the lesson | teacher |
| Person doing the exercise | learner |
| Editable starting files | starter code |
| Browser-rendered result | preview |
